...
进阶专题系列深入拆解了这些方向，见 [🚀 进阶专题](./roadmap#jin-jie-zhuan-ti)：
...
**[Multi-modal RAG](./multimodal-rag)**：
...
**[Self-RAG](./self-rag)** / **[Corrective RAG](./corrective-rag)**：

- LLM 自评检索质量（Self-RAG 反思 token）
- 检索失败 web 兜底（CRAG）
- 动态调整检索策略
...
> *下一篇：[GraphRAG 图谱增强检索](./graphrag) -- 进阶专题首篇，知识图谱 + 社区聚类，专治全局性问题。*
